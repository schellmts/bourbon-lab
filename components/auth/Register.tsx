  ...
  return (
    <View className='flex bg-primary flex-1 items-center gap-5 justify-center px-10'>
      ...
      <View className='w-[80%] flex gap-4'>
        ...
        <TextInput value={confirmPassword} onChangeText={setConfirmPassword} className='border border-1 border-secondary rounded-xl bg-primary_2 px-4 text-secondary' placeholder='Confirm Password' secureTextEntry placeholderTextColor='#DDB967' />
      </View>
      <View className='w-[80%] flex gap-4'>
        ...
        <Text className='font-marcellus text-[14px] text-white text-center'>Already have a account? <Link className='text-third' href={'/'}>Enter Now</Link></Text>
      </View>
